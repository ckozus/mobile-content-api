...
Translation.find_or_create_by!(resource: kgp, language: english, version: 1, status: 2)
Translation.find_or_create_by!(resource: kgp, language: german, version: 1, status: 2)
...
Translation.find_or_create_by!(resource: satisfied, language: english, version: 1, status: 2)
Translation.find_or_create_by!(resource: satisfied, language: english, version: 2, status: 2)
Translation.find_or_create_by!(resource: satisfied, language: english, version: 3)
Translation.find_or_create_by!(resource: satisfied, language: german, version: 1, status: 2)
Translation.find_or_create_by!(resource: satisfied, language: german, version: 2, status: 2)

Translation.find_or_create_by!(resource: kgp, language: chinese, version: 1, status: 2)
